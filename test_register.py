...
def test_register_10_role_select_default(page: Page):
    setup_register_dialog(page)
    role_dropdown = page.get_by_role("combobox").nth(1)
...
def test_register_11_select_master_admin(page: Page):
    ...
    role_dropdown.click()
    page.get_by_role("listbox").get_by_role("option", name="マスター管理者").click()
    expect(role_dropdown).to_have_text("マスター管理者")
...
def test_register_12_select_tenant_admin(page: Page):
    ...
    role_dropdown.click()
    page.get_by_role("listbox").get_by_role("option", name="テナント管理者").click()
    expect(role_dropdown).to_have_text("テナント管理者")
...
def test_register_13_role_single_selection_only(page: Page):
    ...
    expect(role_dropdown).to_have_text("テナント管理者")
    expect(role_dropdown).not_to_have_text("マスター管理者")
